...
public enum Field_Fill_Result {
     ...
     * <p>Example: target output stream is closed, or closed connection from client that may causes io exception from input stream</p>
     */
    Failed_IO_Error,
    /**
     * Means the required http parameter data could not get parsed(decoded) to field type.
     * <p>Example: bad number format</p>
     */
    Failed_Parse_Error,
    /**
