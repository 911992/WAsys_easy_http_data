...
public interface Fillable_Object_Parse_Cache_Accelerator {
     ...
     * <p>
     * The given {@code arg_arg} is supposed to stored in a class level place that could be accessed very fast.
     * </p>
     ...
     * <p>
     * Considering, that calling this method from any instance should result a same cache result, or inconsistency and UB will be happened.
     * </p>
